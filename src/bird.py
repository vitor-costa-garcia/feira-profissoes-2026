...
class Bird:
    def __init__(self, screen):
        ...
        if screen:
            self.frames = [
                pygame.image.load(
                    "sprites/birds/benedito/benedito-upflap.png"
                ).convert_alpha(),
                pygame.image.load(
                    "sprites/birds/benedito/benedito-midflap.png"
                ).convert_alpha(),
                pygame.image.load(
                    "sprites/birds/benedito/benedito-downflap.png"
                ).convert_alpha(),
            ]
    ...
    def get_hitbox(self):
        ...
        if self.frames:
            ...
            hitbox = pygame.Rect(
                self.pos.x - BIRD_WIDTH / 2,
                self.pos.y - BIRD_THICK / 2,
                BIRD_WIDTH,
                BIRD_THICK,
            )
